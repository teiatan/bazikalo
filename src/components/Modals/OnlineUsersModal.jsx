...
export const OnlineUsersModal = memo(({ onClose }) => {
  ...
  return (
    <ModalCover onClose={onClose}>
      <div className="p-6">
        ...
        <ul style={{ height: '350px' }} className="items-start w-[600px] overflow-hidden overflow-y-scroll">
                ...
                {openDropDownIndex === index && (
                  ...
                  >
                    <DropDownField>
                      ...
                      {isInBlackList(user) ? (
                        <DropDownItem key={nanoid()} text={"Видалити з чорного списка"}>
                          <AiOutlineStop />
                        </DropDownItem>) :
                        (<DropDownItem key={nanoid()} text={"Додати в чорний список"}>
                          <AiOutlineStop />
                        </DropDownItem>
                        )}
                    </DropDownField>
